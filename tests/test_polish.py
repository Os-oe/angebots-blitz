...
def main():
    ...
    with sync_playwright() as pw:
        ...
        unit_inline = m.evaluate("getComputedStyle(document.querySelector('.unit-inline')).display")
        unit_col = m.evaluate("getComputedStyle(document.querySelector('td.unit-col')).display")
        check("390px: Einheit in Mengen-Zelle gemerged („8 Std.“)", unit_inline == "inline" and unit_col == "none", f"{unit_inline}/{unit_col}")
